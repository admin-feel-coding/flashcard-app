...
export function DeckCard({ deck, onEdit, onDelete }: DeckCardProps) {
  ...
  return (
    <Card className="group bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 shadow-sm hover:shadow-md transition-all duration-200 hover:scale-[1.01] rounded-xl overflow-hidden">
      <CardHeader className="p-4 sm:p-5 md:p-6 pb-3 sm:pb-4">
        ...
        {deck.description && (
          <p className="text-sm sm:text-base text-gray-600 dark:text-gray-300 line-clamp-2 mb-3 sm:mb-4 leading-relaxed">{deck.description}</p>
        )}
